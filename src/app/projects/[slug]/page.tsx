...
const projects: Record<string, ProjectData> = {
  ...
  "luxur": {
    ...
    description: "An elegant e-commerce platform showcasing luxury products with sophisticated design and smooth user interactions.",
    detailedDescription: "Luxur is a premium e-commerce platform designed for luxury product retail. The platform emphasizes sophisticated visual design, smooth user interactions, and premium brand positioning. Built with modern frontend technologies, it showcases advanced UI/UX principles while maintaining excellent performance and accessibility standards.",
    imageUrl: "/luxur.png",
    imageCaption: "Luxur homepage featuring the exclusive collection showcase with elegant dark theme design",
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">View the deployed project</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">View source code and documentation</div>
                </div>
              </a>
            </div>
          </div>
